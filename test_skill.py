...
### 三、正向资本盘点
1. 相位角（wholeBodyPhaseAngle50khz）：高=细胞年轻
   - 话术："电池健康度，抗老能力超强"
   - 如果数据缺失，可从骨骼、水分比率等方面挖掘
...
3. 运动（合理运动）
   - 力量训练：弹力带、小哑铃、扶椅深蹲
   - 有氧运动：每周3-4次，30-40分钟，快步走/游泳/骑车
4. 饮食（均衡营养）
   - 抗衰蛋白：鱼虾、鸡胸、豆腐、鸡蛋、乳清蛋白粉
   - 抗炎营养素：黄酮、多酚、花青素含量高的水果蔬菜
   - 血管清道夫：深海鱼油（Omega-3）清除脂肪，搭配卵磷脂（血管清道夫）将脂肪运输出去，协同守护心血管
   - 低GI主食：燕麦、糙米、红薯、玉米
